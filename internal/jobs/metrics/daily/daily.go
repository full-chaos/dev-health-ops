...
//
// CHAOS-3092 (PR-A'): pythonGatedFinalizeFamilies and the Python
// compatibility bridge it gated are deleted entirely in this change -- by
// the time this PR landed, #2311 (CHAOS-4288) had already emptied that list
// (every recognised family, including benchmarking, had deleted its Python
// compute), so there is no longer any live Python gate line for this file to
// track, and no bridge left for a missing native executor to fall open to.
