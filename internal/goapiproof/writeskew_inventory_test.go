...
var writeSkewRefusalPlaces = map[string]string{
	...
	"RefusalDeclaredBaselineErrorGoLeg":    "not an axis: GraphQL prover only",
	"RefusalInvalidDeclaredBaselineError":  "not an axis: GraphQL prover only",
	"RefusalStaleBaselineErrorDeclaration": "not an axis: GraphQL prover only",
