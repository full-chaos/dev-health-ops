...
def run_reference_discovery_populate_strict(
    *, context: Mapping[str, Any]
    ...
    Extracted (CHAOS-4175) so run_sync_reference_discovery's in-process
    Celery task call -- which already has `context` from computing the
    discovery scope -- has one place to call. Calls the module-level
