...
class TestPostgresUpgrade:
    def test_application_schema_and_cutover_are_separate_heads(self) -> None:
        ...
        assert set(scripts.get_heads()) == {"0066", "0091"}
        assert scripts.get_revision("application_schema@head").revision == "0091"
        assert _database_has_revision(cfg, ("0091",), "0065")
        assert not _database_has_revision(cfg, ("0091",), "0066")
