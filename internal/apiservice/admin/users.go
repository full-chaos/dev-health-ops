...
func userResponseObject(u *fullUser) *pyjson.Object {
	...
	out.Set("created_at", pyjson.TimeString(u.CreatedAt))
	out.Set("updated_at", pyjson.TimeString(u.UpdatedAt))
	return out
}
...
func (h *handlers) getUser(w http.ResponseWriter, r *http.Request) {
	...
	policy.WritePyJSON(w, http.StatusOK, userResponseObject(target), nil)
}
...
func (h *handlers) createUser(w http.ResponseWriter, r *http.Request) {
	...
	policy.WritePyJSON(w, http.StatusCreated, userResponseObject(created), nil)
}
...
func (h *handlers) updateUser(w http.ResponseWriter, r *http.Request) {
	...
	policy.WritePyJSON(w, http.StatusOK, userResponseObject(updated), nil)
}
...
func (h *handlers) setUserPassword(w http.ResponseWriter, r *http.Request) {
	...
	if violations := validatePassword(newPassword); len(violations) > 0 {
		...
		policy.WritePyJSON(w, http.StatusUnprocessableEntity, out, nil)
		return
	}
