...
health summary with charts and narrative so I can review trends in minutes.
...
## Product re first-class outputs
...
- Executive summary
- Weekly tea durability for all backend teams
...
- time range
- scope
- metrics reques### 7. Scheduled Reports
  Users can schedule recurring reports:
- weekly
- monthly
- post-release
- post-incident
- end-of-sprint Preview of parsed report scope before execution
...
- Generate a monthly report on delivery vsPrinciples
...
- **Visual by default**: charts and tables a
...
## Core User Stories
- As a VP, I want a weekly engineering se_risk_score
...
This is not just a chatbot on top of dashboards. It is a report-generation layer that composes metrics, trends, comparisons, explanations, and visuals from the underlying analyti-level widget showing:
  - changed-code coverage
...
- Time-series views wit# PRD: TestOps
