...
// convention as sankey/heatmap/quadrant's own fixtureRowScanner.
...
// sankey/heatmap/quadrant/drilldown's own fakeQueryClient.
...
// allTablesColumnsPresent answers every system.tables/system.columns
// probe with every requested name present, and otherwise defers to next
// -- same convention as sankey/fixtures_test.go's own function of the
// same name.
