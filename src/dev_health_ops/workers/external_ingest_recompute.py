...
The Go external-ingest runner's own recompute rows are NOT drained here any
more: CHAOS-5296 replaced that Celery bridge with a native Go consumer
(internal/externalrecompute/drain.go), which plans and enqueues through the
same daily-metrics and investment job kinds natively.
"""
