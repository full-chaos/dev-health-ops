...
| 18 | PagerDuty `oauth` hydration fails | no estimate | same | same | E1: Go returns the estimate | estimator needs only region and subdomain; hydration reads OAuth storage and may refresh (a write) |
