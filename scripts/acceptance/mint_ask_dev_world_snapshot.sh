...
unset \
  ...
  WORKER_GITHUB_WORK_ITEMS_ENABLED WORKER_GITHUB_WORK_ITEMS_STATUS_MAPPING_PATH WORKER_GITHUB_WORK_ITEMS_INVESTMENT_CONFIG_PATH \
  WORKER_GITHUB_BLAME_ENABLED WORKER_GITHUB_CICD_ENABLED WORKER_GITHUB_COMMITS_ENABLED \
  WORKER_GITHUB_COMMIT_STATS_ENABLED WORKER_GITHUB_DEPLOYMENTS_ENABLED WORKER_GITHUB_FILES_ENABLED \
  WORKER_GITHUB_PRS_ENABLED WORKER_GITHUB_PR_COMMENTS_ENABLED WORKER_GITHUB_PR_REVIEWS_ENABLED \
  WORKER_GITHUB_SECURITY_ENABLED WORKER_GITHUB_TESTS_ENABLED \
  WORKER_GITLAB_REPO_METADATA_ENABLED WORKER_GITLAB_INCIDENTS_ENABLED \
  WORKER_GITLAB_BLAME_ENABLED WORKER_GITLAB_CICD_ENABLED WORKER_GITLAB_COMMITS_ENABLED \
  WORKER_GITLAB_COMMIT_STATS_ENABLED WORKER_GITLAB_DEPLOYMENTS_ENABLED WORKER_GITLAB_FEATURE_FLAGS_ENABLED \
  WORKER_GITLAB_FILES_ENABLED WORKER_GITLAB_PRS_ENABLED WORKER_GITLAB_PR_COMMENTS_ENABLED \
  WORKER_GITLAB_PR_REVIEWS_ENABLED WORKER_GITLAB_SECURITY_ENABLED WORKER_GITLAB_TESTS_ENABLED \
  WORKER_GITLAB_WORK_ITEMS_ENABLED \
  WORKER_JIRA_INCIDENTS_ENABLED WORKER_JIRA_WORK_ITEMS_ENABLED \
  WORKER_LINEAR_WORK_ITEMS_ENABLED \
  WORKER_PAGERDUTY_BUSINESS_SERVICES_ENABLED WORKER_PAGERDUTY_ESCALATION_POLICIES_ENABLED \
  WORKER_PAGERDUTY_INCIDENTS_ENABLED WORKER_PAGERDUTY_ON_CALLS_ENABLED \
  WORKER_PAGERDUTY_SCHEDULES_ENABLED WORKER_PAGERDUTY_SERVICES_ENABLED \
  WORKER_PAGERDUTY_TEAMS_ENABLED WORKER_PAGERDUTY_USERS_ENABLED \
