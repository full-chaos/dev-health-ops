...
# CHAOS-4026 (2026-08-21): test_postgres_pending_occurrence_consumer_skips_locked_replica
# and test_postgres_occurrence_consumer_skips_locked_pair_and_poison_prefix
# (reconcile_pending_scheduled_sync_occurrences concurrency coverage) were
# removed along with the deleted never-live occurrence-consumer engine. See
