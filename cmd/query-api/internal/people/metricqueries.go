...
//     class of mismatch cmd/query-api/internal/analytics/
//     investmentquality.go's own row-type doc comment and
//     cmd/query-api/internal/reviewedges/reviewedges.go:145's
//     ReviewsCount both document) -- normalizing the SQL side to Float64,
//     the same fix cmd/query-api/internal/quadrant/quadrant.go's own
