...
func TestParsePRDetailID(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"largest UInt32 number is accepted", repo + "#pr4294967295", repo, 4294967295, true},
		{"number one above UInt32 is refused", repo + "#pr4294967296", "", 0, false},
		{"number that wraps to an existing pull request is refused", repo + "#pr4294967297", "", 0, false},
