...
class TestDispatchIdempotency:
    ...
    # CHAOS-4026 (2026-08-21): tests for the never-live
    # consume_pending_scheduled_sync_occurrences consumer and its
    # reconcile_pending_scheduled_sync_occurrences engine (formerly here:
    # future-marker replay, deterministic/bounded reconciliation, oversized
    # limit capping, isolated failed-row handling, retry exhaustion,
    # identity-conflict/org-mismatch/config-job-pair quarantine, quarantined-
    # prefix skip-ahead) were removed along with the deleted implementation.
