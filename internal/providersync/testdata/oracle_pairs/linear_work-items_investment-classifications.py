"""Live Python oracle for Linear investment classifications."""
...
def _build_row(case: dict[str, Any]) -> dict[str, Any]:
    _issue_types, classifications, _metrics = DerivedCase(
        case
...
oracle_registry.register(
    oracle_registry.PairSpec(
        id="linear/work-items/investment-classifications",
