...
if _PROMETHEUS_AVAILABLE:
    ...
    ASK_DEV_GRAPH_ASSEMBLY_OUTCOME_TOTAL = _prometheus_client_module.Counter(
        ...
        "graph-routing packet (CHAOS-3502/3650/3741), by outcome: "
        "'assembled_clean' (no evidence refusal, admission gap, or enrichment "
        "gap), "
        ...
        "enrichment source was unavailable), 'assembled_degraded_evidence_gap' "
        "(canonical admission was unavailable/unconfigured or support was "
        "stale), and the closed pair/all combinations of those three causes; "
        "'assembled_degraded_driver_projection_truncated' when only the "
        "public driver cap bites, or the corresponding "
        "'_and_driver_projection_truncated' suffix when it combines with "
        "another degrade cause; "
