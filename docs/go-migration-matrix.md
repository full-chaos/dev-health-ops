...
| `dev-hops metrics release-impact` | **REMOVED** -- `job_release_impact.py` (CLI verb + `run_release_impact_job`) deleted in CHAOS-5244; the family's native Go executor (CHAOS-4296) has no Python fallback | -- (deleted) | CHAOS-5244 (Done) |
