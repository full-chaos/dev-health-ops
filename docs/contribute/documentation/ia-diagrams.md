---
page_id: con-doc-ia-diagrams
summary: Explanatory views of the documentation information architecture, placement decisions, page lifecycle, and URL topology.
...
These diagrams are explanatory views of the IA manifest. The TSV manifest is authoritative for node IDs and URLs.
...
## 5. Source-to-canonical disposition

```mermaid
flowchart LR
  CURRENT["Existing source material"] --> INVENTORY["Documentation inventory"]
