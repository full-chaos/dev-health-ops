...
# CHAOS-4026 (2026-08-21): consume_pending_scheduled_sync_occurrences and its
# reconcile_pending_scheduled_sync_occurrences/_complete_.../_defer_.../
# _quarantine_.../_scheduled_occurrence_identity_is_valid helpers were
# deleted. This consumer was gated by SYNC_SCHEDULED_OCCURRENCE_CONSUMER_ENABLED,
# defaulted False, and per CHAOS-4056's beat-schedule inventory was never
# registered in Python production at all -- Beat stopping on 2026-08-19
# changed nothing for it. It was "functionally folded into the Go product
# scheduler's own claim/materialize/retry/quarantine transaction"
# (internal/scheduler/fixed/inventory.go:503-511) by design, not by this
# cleanup. See tests/workers/test_celery_dead_code_contract.py.
