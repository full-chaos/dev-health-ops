...
| --- | --- | --- | --- | --- | --- | --- |
| `ai_governance` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/aigovernance/compute_test.go::TestGovernanceRowsMatchLivePythonProduction (live-Python full-row oracle over both ai_policy_events and ai_governance_coverage_daily, every persisted column except event_id/computed_at, gated by ci/check_go.sh live-python-oracles) plus TestDeriveEventIDMatchesItsFrozenGoldenValue (frozen event_id, the one field the oracle excludes)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `ai_impact` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/aiimpact/compute_test.go::TestAIImpactMatchesFrozenPythonGolden (frozen golden tests/fixtures/ai_impact_python_golden.json, captured from the now-deleted compute_ai_impact_metrics_daily before its removal, compared field-for-field and bit-exact on floats)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `ai_workflow` | daily | NATIVE | VERIFIED (CHAOS-4286 @ `506c99beb3ec`, internal/jobs/metrics/aiworkflow/oracle_test.go TestAIWorkflowMatchesFrozenPythonGolden (frozen Python golden fixture; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `cicd` | daily | NATIVE | VERIFIED (CHAOS-4292 @ `506c99beb3ec`, internal/jobs/metrics/daily/cicd/compute_test.go TestComputeMatchesFrozenPythonGolden + TestComputeMatchesFrozenGoldenExhaustively (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `compounding_risk` | daily | POST_BRIDGE | VERIFIED (CHAOS-4287 @ `506c99beb3ec`, internal/jobs/metrics/daily/compoundingrisk/compute_test.go TestComputeMatchesFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `deploy` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/numerical/deploy_parity_test.go: TestComputeDeployMetricsGoldenParity (tests/fixtures/daily_deploy_python_golden.json)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `file_hotspots` | daily | NATIVE | VERIFIED (CHAOS-4277 @ `506c99beb3ec`, internal/jobs/metrics/daily/filehotspots/golden_full_test.go TestComputeMatchesFrozenPythonGolden (ComputeFileHotspots leg; frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `file_risk_hotspots` | daily | NATIVE | VERIFIED (CHAOS-4277 @ `506c99beb3ec`, internal/jobs/metrics/daily/filehotspots/golden_full_test.go TestComputeMatchesFrozenPythonGolden (ComputeFileRiskHotspots leg; frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `incident` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/daily/incident_parity_golden_test.go: TestComputeIncidentMetricsDailyMatchesFrozenPythonGolden (testdata/incident_parity_golden.json)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `repo_user_commit` | daily | NATIVE | VERIFIED (CHAOS-4275 @ `506c99beb3ec`, internal/jobs/metrics/daily/repouser/compute_test.go TestComputeMatchesFrozenPythonGolden + golden_full_test.go TestComputeMatchesFrozenGoldenExhaustively (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `review_edges` | daily | NATIVE | VERIFIED (CHAOS-4279 @ `506c99beb3ec`, internal/jobs/metrics/daily/reviewedges/compute_test.go TestComputeMatchesFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `team_wellbeing` | daily | NATIVE | VERIFIED (CHAOS-4276 @ `506c99beb3ec`, internal/jobs/metrics/numerical/wellbeing_parity_test.go TestTeamWellbeingGoldenParity (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `testops_coverage` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/testops/parity_golden_test.go: TestComputeCoverageMetricMatchesFrozenPythonGolden (testdata/testops_coverage_parity_golden.json)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `testops_pipeline` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/testops/parity_golden_test.go: TestComputePipelineMetricsMatchesFrozenPythonGolden (testdata/testops_pipeline_parity_golden.json)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `testops_risk` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/daily/testops_risk_parity_golden_test.go: TestTestopsRiskComputeMatchesFrozenPythonGolden (testdata/testops_risk_parity_golden.json)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `testops_test` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/testops/parity_golden_test.go: TestComputeTestMetricsMatchesFrozenPythonGolden (testdata/testops_test_parity_golden.json)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `work_graph_edges` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/workgraphedges/compute_test.go TestWorkGraphEdgesMatchFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `work_item` | daily | NATIVE | VERIFIED (CHAOS-4283 @ `506c99beb3ec`, internal/jobs/metrics/workitemmetrics/golden_test.go TestComputeDailyTripletMatchesPythonGolden (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `work_item_attribution` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/providersync/work_item_attribution_backstop_oracle_test.go TestWorkItemAttributionBackstopMatchesLivePythonProduction (exercises remaining.BuildWorkItemAttributionRows, the same row-building function this family's native executor calls, against a frozen Python oracle snapshot; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
| `work_item_estimate` | daily | NATIVE | VERIFIED (CHAOS-5323 @ `506c99beb3ec`, internal/jobs/metrics/workitemmetrics/golden_test.go TestComputeEstimateCoverageMatchesPythonGolden (frozen Python golden; PASS re-run at this sha)) | `dd77701c5623` (read 2026-09-20T11:13:37Z) | **none** | -- |
...
_Rendered 2026-09-20T11:13:37Z against main merge-base `1205ec23c1cf05a32f925a49f96ff1e0d58a0f69`; SDL digest pin `sha256:898250a995e65f792e0383a07d7a683251894cbe51f426a4dcf520bcd82bf91e`; fleet read 2026-09-20T11:13:37Z via fleet file fleet-prod.json._

_Rows in `go_api_proof_run` at read time: **515**. Operations reachable to real clients with no deployed-executed proof: **0**. Rows whose mode says Go but whose schema digest no longer matches the pin, so every request silently falls back to Python: **17**._
...
| --- | --- | --- | --- | --- | --- | --- |
| `capacityForecast` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `a33096fa-f28f-4b77-a47d-10827d0dbe87` | -- |
| `capacityForecasts` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `1d3b8a44-3481-4cac-bbd6-270774a8d195` | -- |
| `cognitiveLoad` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `53228aac-a49e-4269-a1ca-d58a8288f738` | -- |
| `complexityTimeseries` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `c2a462a9-f02d-4ae6-ab6f-9fcc73b537b6` | -- |
| `featureFlagEvents` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `6e8e1464-cd16-4fc1-b074-b0963cf48f18` | -- |
| `featureFlags` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `be7562b3-8635-4c04-946a-d520c401bda7` | -- |
| `flowMatrix` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `0cc32c9a-1b9b-4c59-b04e-b728616843df` | -- |
| `hotspots` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `2a4defef-050b-4a5f-b1f5-0b8d0d1cd02d` | -- |
| `investmentBreakdown` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `2c52c59d-1d3f-485d-9152-bd70401e297a` | -- |
| `investmentFull` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `7efcc06d-b1c6-4d0e-8d71-547a4a50fb32` | -- |
| `operatingReview` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `2c7a10a0-0710-4b8a-af5a-9057e4913a28` | -- |
| `pr` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `b3aaeb66-8b59-448c-8442-e9a46c68f034` | -- |
| `reviewEdges` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `d296baf1-ff70-4cd9-a7b1-4918000063bf` | -- |
| `throughputForecast` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `c8a33ae9-f085-44b2-8413-9cf3c0dbcd2a` | -- |
| `workGraphArtifacts` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `8846737d-8f95-41a9-800b-5227fa0e469e` | -- |
| `workGraphEdges` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `4f051952-cb30-4978-9067-d14545d53496` | -- |
| `workGraphFlow` | canary | `sha256:19485ec136d04d…` | `39e25d366512` | **DEAD** (digest moved) | `17d38566-fa6a-454d-8f73-d11ded30c905` | -- |
