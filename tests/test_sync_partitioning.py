...
class TestExtractProviderToken:
    def test_linear_apiKey(self):
        ...
        assert _extract_provider_token("linear", {"apiKey": "lin_api_xxx"}) == "lin_api_xxx"

    def test_linear_api_key(self):
        from dev_health_ops.workers.tasks import _extract_provider_token
        assert _extract_provider_token("linear", {"api_key": "lin_api_yyy"}) == "lin_api_yyy"

    def test_linear_prefers_api_key_over_apiKey(self):
        from dev_health_ops.workers.tasks import _extract_provider_token
        result = _extract_provider_token("linear", {"api_key": "snake", "apiKey": "camel"})
        assert result == "snake"
...
class TestNormalizeCredentialKeys:
    ...
    def test_jira_normalizes_multiple_keys(self):
        from dev_health_ops.api.services.settings import _normalize_credential_keys
        result = _normalize_credential_keys("jira", {"apiToken": "tok", "baseUrl": "https://jira.example.com", "email": "a@b.com"})
        assert result == {"api_token": "tok", "base_url": "https://jira.example.com", "email": "a@b.com"}
    ...
    def test_github_normalizes_baseUrl(self):
        from dev_health_ops.api.services.settings import _normalize_credential_keys
        result = _normalize_credential_keys("github", {"token": "ghp_xxx", "baseUrl": "https://gh.example.com"})
