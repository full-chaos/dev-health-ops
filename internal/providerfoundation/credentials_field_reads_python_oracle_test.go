...
// text of each field the provider reads, containers included. Not in the
// table: Python's linear builder reads the apiKey alias where Go's shape check
// reads only api_key (CHAOS-6782).
