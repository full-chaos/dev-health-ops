---
page_id: con-doc-content-model
summary: The authoring contract for page types, required metadata, risk-based review, and source-of-truth policy.
...
This is the authoring contract for published documentation. It defines the supported page types, the metadata a page must carry, and the review a page must pass.
