...
for text in json.loads(sys.stdin.read()):
    ...
    if value is None:
        ...
        out.append([value.isoformat(), None if offset is None else int(offset.total_seconds())])
...
func jiraDatetimeCorpus() []string {
	return []string{
		...
		"2026-09-01T24:00:00", "2026-12-31T24:00", "2026-09-01T24:00:00.1", "2026-09-01T24:01", "2026-09-01T10:00:00-23:59:59", "2026-09-01T10:00:00-24:00", "2026-09-01T10:60:00", "2026-09-01T10:00:60", "2026-09-01T10:00:00+24:00", "2026-09-01T10:00:00.Z",
...
func goJiraDatetime(text string) any {
	...
	iso := stamp.Time.Format("2006-01-02T15:04:05")
	...
	iso += fmt.Sprintf("%s%02d:%02d", sign, abs/3600, abs%3600/60)
	if abs%60 != 0 {
		iso += fmt.Sprintf(":%02d", abs%60)
	}
	return []any{iso, offset}
}
