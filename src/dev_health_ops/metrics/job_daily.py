...
async def run_daily_metrics_finalize(
    *,
    ...
    # call are gone too -- neither is read anywhere else in this function
    # now that benchmarking was the last consumer (CHAOS-3092 PR-A': with
    # pythonGatedFinalizeFamilies now empty, `skip_families` itself is
    # reconsidered as part of removing the finalize bridge call entirely).
