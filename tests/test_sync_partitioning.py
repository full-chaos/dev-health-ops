...
# CHAOS-5351: TestWorkItemsProviderCredentialIsolation used to live here,
# calling run_work_items_sync_job directly (mocking only ClickHouseMetricsSink
# and _discover_repos) to pin the CHAOS-2720/CHAOS-2763 source-scoping /
# fail-closed-on-missing-source contract for github/gitlab/linear work-item
# units. Deleted along with run_work_items_sync_job -- the native
# provider-sync route (cmd/dev-health-worker/provider_sync.go's work-items
# dataset case) owns the same source-scoping contract now, at the Go layer.
