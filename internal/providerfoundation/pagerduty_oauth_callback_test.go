...
func TestPagerDutyTokensFromPayloadMatchesTokens(t *testing.T) {
	...
	cases := []struct {
		...
		{"numeric access_token is str()ed", `{"access_token":123}`, nil, "123", "", "", 3600},
		{"boolean and null values are str()ed", `{"access_token":true,"refresh_token":456,"scope":null}`, nil, "True", "456", "None", 3600},
		{"numeric scope", `{"access_token":"a","scope":7}`, nil, "a", "", "7", 3600},
		{"falsy refresh_token is none", `{"access_token":"a","refresh_token":0}`, nil, "a", "", "", 3600},
		{"list access_token is its repr", `{"access_token":[1,"x"]}`, nil, "[1, 'x']", "", "", 3600},
		{"null access_token is None", `{"access_token":null}`, nil, "None", "", "", 3600},
