...
// Line is the stdout line naming both builds, every field explicit.
func (b ProverBuild) Line() string {
	return fmt.Sprintf("prover_build=%s prover_build_modified=%t candidate_build=%s prover_build_skew=%t prover_build_skew_allowed=%t", b.Prover, b.ProverModified, b.Candidate, b.Skew, b.SkewAllowed)
}
