...
flowchart LR
  ...
  queryadapter -->|neutral row/query reads| sharedlib[shared Go library, Wave 0 extraction: CH client + org-scoping/reader-dedup + devhealthschema contracts + JWKS/token-exchange/token-review mechanisms]
