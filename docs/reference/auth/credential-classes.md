...
| `worker_operational_bridge_token` (`WORKER_OPERATIONAL_BRIDGE_TOKEN`) | `/api/internal/worker-operational`, `/internal/worker`, `/api/internal/worker-sync` | **No.** None of these paths start with `/api/v1/internal/acr/`. |
