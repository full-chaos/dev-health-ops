...
// can reach survive (throws, "{"/entering-imp, the not-an-identifier
// fallback, and the old-c-params default) -- throw/noexcept/trailing-return
// specifiers and initializer lists are C++-only and unreachable here.
