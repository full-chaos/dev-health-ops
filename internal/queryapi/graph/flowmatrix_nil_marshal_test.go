...
func TestMarshalNSankeyNodeSlice_Nil_ProducesEmptyArray(t *testing.T) {
	...
	result := ec.marshalNSankeyNode2ᚕgithubᚗcomᚋfullᚑchaosᚋdevᚑhealthᚑopsᚋinternalᚋqueryapiᚋgraphᚋmodelᚐSankeyNodeᚄ(ctx, nil, nilNodes)
	...
	edgeResult := ec.marshalNSankeyEdge2ᚕgithubᚗcomᚋfullᚑchaosᚋdevᚑhealthᚑopsᚋinternalᚋqueryapiᚋgraphᚋmodelᚐSankeyEdgeᚄ(ctx, nil, nilEdges)
