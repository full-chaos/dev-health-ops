...
// outside cmd/query-api, which Go's internal-package rule then barred
// from query-api's packages (at that time under cmd/query-api). The
// implementation therefore moved to internal/goapidigest, reachable from
// every binary in the module, and this package now forwards to it.
//
