...
import "github.com/full-chaos/dev-health-ops/internal/storage/roleacl"

// legacyRolePostureQuery is rolePostureQuery exactly as it stood on main before
// CHAOS-6937 (c724e4d95): the has_*_privilege sweeps and
// information_schema.column_privileges. It is the differential ORACLE for the
// catalog rewrite: the rewrite must agree with it, boolean for boolean, on every
// grant scenario in role_posture_query_oracle_integration_test.go. Do not edit
// it to make a scenario pass; that defeats its purpose.
const legacyRolePostureQuery = `
