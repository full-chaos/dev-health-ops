...
// deployGoldenPath is the checked-in fixture generated by
// tests/fixtures/generate_daily_deploy_python_golden.py.
...
// reproduces the frozen Python golden (CHAOS-4293).
