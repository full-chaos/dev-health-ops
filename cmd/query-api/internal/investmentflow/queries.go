...
// same way cmd/query-api/internal/analytics/investment.go and
// cmd/query-api/internal/sankey's own readers already are.
//
...
// binary's own cmd/query-api/internal/analytics.repoAllocationInvestment
