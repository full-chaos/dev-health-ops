...
// placeholder every other instrument in this binary already is, not a
// regression this PR introduces or a claim that the histogram is exported
// today.
...
func mustMembershipRatioHistogram(name, description string) metric.Float64Histogram {
	meter := otel.Meter("github.com/full-chaos/dev-health-ops/internal/queryapi/workgraph")
