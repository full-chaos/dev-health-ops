...
// (tests/fixtures/file_hotspots_python_golden.json, generated by
// tests/fixtures/generate_file_hotspots_python_golden.py against REAL
// production Python) and asserts ComputeFileHotspots/ComputeFileRiskHotspots
// reproduce it exactly for both repositories in the fixture -- including the
// AGGREGATE_STATS_MARKER skip, the empty-file_path skip, cross-repo
// isolation, the complexity-only union case, and both the present/absent
// blame_concentration branches. See golden_rot_guard_test.go for the
// counterpart that checks the frozen file itself hasn't drifted from live
// Python.
