...
KIND_LEDGER: dict[str, dict[str, str]] = {
    ...
    "sync.provider_unit": {
        ...
        "state": "native",
        "ticket": "n/a — matches migration-state.json celery_removed state, no gap. The Python run_sync_unit celery task body is deleted (was unreachable from any live dispatch path -- no Celery consumer, no HTTP bridge).",
    },
