...
# LIVE. Both files import only stdlib plus a TYPE_CHECKING-only
# ClickHouseStore reference (never evaluated at runtime), so no additional
# stub beyond the four-package namespace chain is needed.
