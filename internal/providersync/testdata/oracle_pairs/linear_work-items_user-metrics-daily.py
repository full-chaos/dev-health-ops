"""Live Python oracle for Linear per-user work-item metrics."""
...
def _build_row(case: dict[str, Any]) -> dict[str, Any]:
    _records, users, _cycles = compute_triplet(case)
    return columns(list(users), _fields())


oracle_registry.register(
    oracle_registry.PairSpec(
        id="linear/work-items/user-metrics-daily",
