...
func TestExternalIngestVenueOracle(t *testing.T) {
	...
	requests := []venueoracle.Request{
		...
		malformedEnvelope("validate storyPoints negative integer past float64 range", "/api/v1/external-ingest/validate", auth,
			`{"schemaVersion":"external-ingest.v1","idempotencyKey":"k","source":{"system":"github","instance":"acme/venue-repo"},"records":[{"kind":"work_item.v1","externalId":"w","payload":{"externalKey":"1","provider":"github","title":"T","type":"issue","status":"todo","createdAt":"2026-07-22T10:00:00Z","repositoryExternalId":"acme/venue-repo","storyPoints":`+"-1"+strings.Repeat("0", 400)+`}}]}`),
		malformedEnvelope("validate storyPoints float literal past float64 range", "/api/v1/external-ingest/validate", auth,
			`{"schemaVersion":"external-ingest.v1","idempotencyKey":"k","source":{"system":"github","instance":"acme/venue-repo"},"records":[{"kind":"work_item.v1","externalId":"w","payload":{"externalKey":"1","provider":"github","title":"T","type":"issue","status":"todo","createdAt":"2026-07-22T10:00:00Z","repositoryExternalId":"acme/venue-repo","storyPoints":`+"1e1000"+`}}]}`),
		malformedEnvelope("validate storyPoints negative float literal past float64 range", "/api/v1/external-ingest/validate", auth,
			`{"schemaVersion":"external-ingest.v1","idempotencyKey":"k","source":{"system":"github","instance":"acme/venue-repo"},"records":[{"kind":"work_item.v1","externalId":"w","payload":{"externalKey":"1","provider":"github","title":"T","type":"issue","status":"todo","createdAt":"2026-07-22T10:00:00Z","repositoryExternalId":"acme/venue-repo","storyPoints":`+"-1e1000"+`}}]}`),
