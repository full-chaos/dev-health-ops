...
| --- | --- | --- | --- | --- | --- | --- |
| `ai_governance` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/aigovernance/compute_test.go::TestGovernanceRowsMatchLivePythonProduction (live-Python full-row oracle over both ai_policy_events and ai_governance_coverage_daily, every persisted column except event_id/computed_at, gated by ci/check_go.sh live-python-oracles) plus TestDeriveEventIDMatchesItsFrozenGoldenValue (frozen event_id, the one field the oracle excludes)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `ai_impact` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/aiimpact/compute_test.go::TestAIImpactMatchesFrozenPythonGolden (frozen golden tests/fixtures/ai_impact_python_golden.json, captured from the now-deleted compute_ai_impact_metrics_daily before its removal, compared field-for-field and bit-exact on floats)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `ai_workflow` | daily | NATIVE | VERIFIED (CHAOS-4286 @ `506c99beb3ec`, internal/jobs/metrics/aiworkflow/oracle_test.go TestAIWorkflowMatchesFrozenPythonGolden (frozen Python golden fixture; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `cicd` | daily | NATIVE | VERIFIED (CHAOS-4292 @ `506c99beb3ec`, internal/jobs/metrics/daily/cicd/compute_test.go TestComputeMatchesFrozenPythonGolden + TestComputeMatchesFrozenGoldenExhaustively (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `compounding_risk` | daily | POST_BRIDGE | VERIFIED (CHAOS-4287 @ `506c99beb3ec`, internal/jobs/metrics/daily/compoundingrisk/compute_test.go TestComputeMatchesFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `deploy` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/numerical/deploy_parity_test.go: TestComputeDeployMetricsGoldenParity (tests/fixtures/daily_deploy_python_golden.json)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `file_hotspots` | daily | NATIVE | VERIFIED (CHAOS-4277 @ `506c99beb3ec`, internal/jobs/metrics/daily/filehotspots/golden_full_test.go TestComputeMatchesFrozenPythonGolden (ComputeFileHotspots leg; frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `file_risk_hotspots` | daily | NATIVE | VERIFIED (CHAOS-4277 @ `506c99beb3ec`, internal/jobs/metrics/daily/filehotspots/golden_full_test.go TestComputeMatchesFrozenPythonGolden (ComputeFileRiskHotspots leg; frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `incident` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/daily/incident_parity_golden_test.go: TestComputeIncidentMetricsDailyMatchesFrozenPythonGolden (testdata/incident_parity_golden.json)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `repo_user_commit` | daily | NATIVE | VERIFIED (CHAOS-4275 @ `506c99beb3ec`, internal/jobs/metrics/daily/repouser/compute_test.go TestComputeMatchesFrozenPythonGolden + golden_full_test.go TestComputeMatchesFrozenGoldenExhaustively (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `review_edges` | daily | NATIVE | VERIFIED (CHAOS-4279 @ `506c99beb3ec`, internal/jobs/metrics/daily/reviewedges/compute_test.go TestComputeMatchesFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `team_wellbeing` | daily | NATIVE | VERIFIED (CHAOS-4276 @ `506c99beb3ec`, internal/jobs/metrics/numerical/wellbeing_parity_test.go TestTeamWellbeingGoldenParity (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `testops_coverage` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/testops/parity_golden_test.go: TestComputeCoverageMetricMatchesFrozenPythonGolden (testdata/testops_coverage_parity_golden.json)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `testops_pipeline` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/testops/parity_golden_test.go: TestComputePipelineMetricsMatchesFrozenPythonGolden (testdata/testops_pipeline_parity_golden.json)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `testops_risk` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/daily/testops_risk_parity_golden_test.go: TestTestopsRiskComputeMatchesFrozenPythonGolden (testdata/testops_risk_parity_golden.json)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `testops_test` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `d00f165f4bcb`, internal/jobs/metrics/testops/parity_golden_test.go: TestComputeTestMetricsMatchesFrozenPythonGolden (testdata/testops_test_parity_golden.json)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `work_graph_edges` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/workgraphedges/compute_test.go TestWorkGraphEdgesMatchFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `work_item` | daily | NATIVE | VERIFIED (CHAOS-4283 @ `506c99beb3ec`, internal/jobs/metrics/workitemmetrics/golden_test.go TestComputeDailyTripletMatchesPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `work_item_attribution` | daily | NATIVE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/providersync/work_item_attribution_backstop_oracle_test.go TestWorkItemAttributionBackstopMatchesLivePythonProduction (exercises remaining.BuildWorkItemAttributionRows, the same row-building function this family's native executor calls, against a frozen Python oracle snapshot; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `work_item_estimate` | daily | NATIVE | VERIFIED (CHAOS-5323 @ `506c99beb3ec`, internal/jobs/metrics/workitemmetrics/golden_test.go TestComputeEstimateCoverageMatchesPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `work_item_state` | daily | NATIVE | VERIFIED (CHAOS-4278 @ `506c99beb3ec`, internal/jobs/metrics/daily/work_item_state_native_executor_test.go TestComputeWorkItemStateDurationsGolden (ports Python's test_time_in_state_is_bucketed_to_day byte-for-byte; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `benchmarking` | finalize | FINALIZE | VERIFIED (CHAOS-4288 @ `506c99beb3ec`, internal/jobs/metrics/daily/benchmarking/compute_test.go TestComputeMatchesFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `compounding_risk_team` | finalize | FINALIZE | VERIFIED (CHAOS-5084 @ `506c99beb3ec`, internal/jobs/metrics/daily/compoundingrisk/team_golden_test.go TestBuildTeamRowsMatchesFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `ic_finalize` | finalize | FINALIZE | VERIFIED (CHAOS-4290 @ `506c99beb3ec`, internal/jobs/metrics/daily/icfinalize/parity_golden_test.go TestICFinalizeMatchesTheFrozenPythonGolden (integration-tagged frozen Python golden; requires a ClickHouse container, part of the committed suite; not independently re-run here -- a missing sqlalchemy venv in this worktree blocked the local re-run attempt)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `team_cognitive_load` | finalize | FINALIZE | VERIFIED (CHAOS-5794 @ `cb9f5f48cece`, internal/jobs/metrics/daily/team_cognitive_load_parity_golden_test.go TestTeamCognitiveLoadMatchesTheFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `team_complexity` | finalize | FINALIZE | VERIFIED (CHAOS-5051 @ `506c99beb3ec`, internal/jobs/metrics/daily/team_complexity_parity_golden_test.go TestTeamComplexityMatchesTheFrozenPythonGolden (frozen Python golden; PASS re-run at this sha)) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `capacity` | remaining | NATIVE | VERIFIED (CHAOS-5800 @ `84e5d60d76a3`, internal/jobs/metrics/numerical/capacity_forecast_test.go TestCapacityForecastMatchesPython (frozen golden tests/fixtures/capacity_forecast_golden.json, 95 cases/5 seeds, whole kernel output) + capacity_golden_rot_guard_test.go TestCapacityForecastGoldenMatchesLivePython (live-CPython rot guard proving the golden still matches live Python, gated DEV_HEALTH_LIVE_PYTHON_ORACLES=1 via ci/check_go.sh live-python-oracles); PASS re-run at this sha) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `complexity` | remaining | NATIVE | VERIFIED (CHAOS-5800 @ `84e5d60d76a3`, internal/jobs/metrics/remaining/complexity_native_integration_test.go TestComplexityExecutorMatchesPythonAgainstClickHouse (native executor's file_complexity_snapshots + repo_complexity_daily writes vs testdata/complexity_python_golden.json, a FROZEN golden captured from the real, shipped run_complexity_db_job on bigboy 2026-09-06 before its deletion); PASS re-run at this sha) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `dora` | remaining | NATIVE | VERIFIED (CHAOS-5800 @ `84e5d60d76a3`, internal/jobs/metrics/numerical/dora_frozen_golden_test.go TestComputeDORAMatchesFrozenPythonGolden (frozen golden tests/fixtures/dora_metrics_python_golden.json, captured from real production Python 2026-07-23 before job_dora.py/compute_dora.py were deleted CHAOS-5336; ComputeDORA is the sole producer now, full DORAMetric struct compared byte-for-byte); PASS re-run at this sha) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `membership_backfill` | remaining | NATIVE | VERIFIED (CHAOS-5800 @ `84e5d60d76a3`, internal/jobs/metrics/remaining/membership_golden_test.go TestComputeOrgMatchesLivePythonBackfillMemberships (CHAOS-4282 byte-parity oracle: ComputeOrg run against tests/fixtures/membership_backfill_golden.json, a golden captured from the real Python backfill_memberships via tests/fixtures/generate_membership_backfill_golden.py; compares full stats, every work_unit_membership row field-for-field, and the work_unit_membership_runs run record); PASS re-run at this sha) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `recommendations` | remaining | NATIVE | VERIFIED (CHAOS-5800 @ `84e5d60d76a3`, internal/jobs/metrics/remaining/recommendations_engine_test.go TestEvaluateStateMatchesTheReference (full row/field EvaluateState output vs testdata/recommendations_engine_golden.json, captured by testdata/generate_recommendations_engine_golden.py driving the live Python RuleEngine.evaluate_state; 80 records/16 cases) + recommendations_rules_test.go's per-rule golden as supporting evidence; PASS re-run at this sha) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `release_impact` | remaining | NATIVE | VERIFIED (CHAOS-5800 @ `84e5d60d76a3`, internal/jobs/metrics/remaining/release_impact_parity_golden_test.go TestReleaseImpactMatchesTheFrozenPythonGolden (native executor's release_impact_daily row, every non-flag column, vs testdata/release_impact_parity_golden.json, a frozen golden captured by running release_impact.py's live _compute_day against an identically-seeded ClickHouse over its HTTP port via clickhouse_connect; capture command recorded in the test's doc comment) + release_impact_fixture_integration_test.go TestReleaseImpactParityClassBattery (row-count/degraded-signal proof for the two zero-row classes this golden cannot cover); PASS re-run at this sha) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `work_item_attribution` | remaining | NATIVE | VERIFIED (CHAOS-5800 @ `84e5d60d76a3`, internal/providersync/work_item_attribution_backstop_oracle_test.go TestWorkItemAttributionBackstopMatchesLivePythonProduction (drives remaining.BuildWorkItemAttributionRows -- the exact mapping ComputePartition calls -- against the frozen github_work-items_team-attributions_backstop Python oracle snapshot, every WorkItemAttributionRow field via githubTeamAttributionColumns); PASS re-run at this sha) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `investment.materialize` | workgraph | NATIVE | VERIFIED (CHAOS-5459 @ `720f64bffc75`, Coverage divergence closed, and output parity pinned by the frozen goldens. Coverage: internal/jobs/investment/repoattribution.go exports dev_health_investment_repo_attribution_total{source} (own|ancestor|children|team|unassigned; the five sum to the run's components); production read 2026-09-20 on the Go worker that runs the workgraph queue, with transitive repository inheritance and the fallback effort across owned repos (internal/jobs/investment/hierarchycascade.go, teamownership.go) in the deployed build: attributed component share 77.07 percent, Investment page team coverage 100 percent, repository coverage 99 percent; the owner accepted that as the coverage bar. Parity: internal/jobs/investment/materialize_python_golden_test.go TestMaterializeOrchestrationMatchesFrozenPythonGolden (orchestration decisions vs the frozen Python golden) and TestFrozenPythonGoldenStillMatchesLivePython (the golden re-checked against live Python); internal/jobs/investment/categorize/*golden_test.go for the LLM-plane prompt, schema and mock-provider goldens. Not covered by any golden: end-to-end component rows against live Python on production data.) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
| `workgraph.build` | workgraph | NATIVE | VERIFIED (CHAOS-5801 @ `cb78f7b67ea4`, every one of the build's 12 native pre-steps has a frozen-Python-golden or live-Python-golden test: stale_pr_dependency_issue_edges_cleanup -> internal/jobs/workgraph/edges/stale_dependency_edges_integration_test.go::TestDeleteStalePRDependencyIssueEdgesAgainstLiveClickHouse; issue_pr_links -> internal/jobs/workgraph/issueprlinks/golden_full_test.go::TestDeriveMatchesFrozenPythonGoldenExhaustively; issue_pr_edges_fast_path and issue_pr_edges_text_parse -> internal/jobs/workgraph/issuepredges/golden_test.go::TestDeriveFastPathAndTextParseEdgesMatchFrozenPythonGolden; issue_commit_edges -> internal/jobs/workgraph/issuecommitedges/golden_test.go::TestDeriveMatchesFrozenPythonGolden; issue_pr_edges_heuristic -> internal/jobs/workgraph/issuepredges/heuristic_golden_test.go::TestDeriveHeuristicEdgesMatchesFrozenPythonGolden; pr_commit_links and pr_commit_edges -> internal/jobs/workgraph/prcommit/golden_test.go::TestDeriveAndBuildFastPathEdgesMatchFrozenPythonGolden; commit_file_edges -> internal/jobs/workgraph/issuecommitedges/commit_file_edges_count_integration_test.go::TestCountCommitFileEdgesMatchesFrozenPythonGolden (new: seeds git_commit_stats and reproduces the frozen readback of the deleted _count_commit_file_edges query for the org-scoped, foreign-org and unscoped calls); flag_guards_edges -> internal/jobs/workgraph/operationaledges/incidents_golden_integration_test.go::TestBuildOperationalEdgesMatchSyntheticGolden; operational_incident_edges -> internal/jobs/workgraph/operationaledges/incidents_golden_integration_test.go::TestBuildOperationalIncidentEdgesMatchesOrg70d529e0Golden; issue_issue_edges -> internal/jobs/workgraph/edges/canonical_golden_test.go::TestDerivationReproducesTheFrozenGolden) | `39e25d366512` (read 2026-09-16T12:25:30Z) | **none** | -- |
...
| --- | --- | --- | --- |
| GET | `/api/v1/drilldown/issues` | ported | `internal/queryapi/server/drilldown_issues_route.go#buildDrilldownIssuesRoute` |
| POST | `/api/v1/drilldown/issues` | ported | `internal/queryapi/server/drilldown_issues_route.go#buildDrilldownIssuesRoute` |
| GET | `/api/v1/drilldown/prs` | ported | `internal/queryapi/server/drilldown_prs_route.go#buildDrilldownPRsRoute` |
| POST | `/api/v1/drilldown/prs` | ported | `internal/queryapi/server/drilldown_prs_route.go#buildDrilldownPRsRoute` |
| GET | `/api/v1/explain` | ported | `internal/queryapi/server/explain_route.go#buildExplainRoute` |
| POST | `/api/v1/explain` | ported | `internal/queryapi/server/explain_route.go#buildExplainRoute` |
| GET | `/api/v1/filters/options` | ported | `internal/queryapi/server/filter_options_route.go#buildFilterOptionsRoute` |
| GET | `/api/v1/flame` | ported | `internal/queryapi/server/flame_route.go#buildFlameRoute` |
| GET | `/api/v1/flame/aggregated` | ported | `internal/queryapi/server/flame_aggregated_route.go#buildFlameAggregatedRoute` |
| GET | `/api/v1/heatmap` | ported | `internal/queryapi/server/heatmap_route.go#buildHeatmapRoute` |
| GET | `/api/v1/home` | ported | `internal/queryapi/server/home_route.go#buildHomeRoute` |
| POST | `/api/v1/home` | ported | `internal/queryapi/server/home_route.go#buildHomeRoute` |
| GET | `/api/v1/investment` | ported | `internal/queryapi/server/investment_route.go#buildInvestmentRoute` |
| POST | `/api/v1/investment` | ported | `internal/queryapi/server/investment_route.go#buildInvestmentRoute` |
| POST | `/api/v1/investment/explain` | ported | `internal/queryapi/server/investment_explain_route.go#buildInvestmentExplainRoute` |
| POST | `/api/v1/investment/flow` | ported | `internal/queryapi/server/investment_flow_route.go#buildInvestmentFlowRoute` |
| POST | `/api/v1/investment/flow/repo-team` | ported | `internal/queryapi/server/investment_flow_route.go#buildInvestmentFlowRoute` |
| GET | `/api/v1/investment/sunburst` | ported | `internal/queryapi/server/investment_route.go#buildInvestmentSunburstRoute` |
| GET | `/api/v1/meta` | ported | `internal/queryapi/server/meta_route.go#buildMetaRoute` |
| GET | `/api/v1/opportunities` | ported | `internal/queryapi/server/opportunities_route.go#buildOpportunitiesRoute` |
| POST | `/api/v1/opportunities` | ported | `internal/queryapi/server/opportunities_route.go#buildOpportunitiesRoute` |
| GET | `/api/v1/people` | ported | `internal/queryapi/server/people_route.go#buildPeopleSearchRoute` |
| GET | `/api/v1/people/{person_id}/drilldown/issues` | ported | `internal/queryapi/server/people_drilldown_issues_route.go#buildPeopleDrilldownIssuesRoute` |
| GET | `/api/v1/people/{person_id}/drilldown/prs` | ported | `internal/queryapi/server/people_drilldown_prs_route.go#buildPeopleDrilldownPRsRoute` |
| GET | `/api/v1/people/{person_id}/metric` | ported | `internal/queryapi/server/people_metric_route.go#buildPeopleMetricRoute` |
| GET | `/api/v1/people/{person_id}/summary` | ported | `internal/queryapi/server/people_summary_route.go#buildPeopleSummaryRoute` |
| GET | `/api/v1/quadrant` | ported | `internal/queryapi/server/quadrant_route.go#buildQuadrantRoute` |
| GET | `/api/v1/sankey` | ported | `internal/queryapi/server/sankey_route.go#buildSankeyRoute` |
| POST | `/api/v1/sankey` | ported | `internal/queryapi/server/sankey_route.go#buildSankeyRoute` |
| GET | `/api/v1/work-units` | ported | `internal/queryapi/server/workunits_route.go#buildWorkUnitsRoute` |
| POST | `/api/v1/work-units` | ported | `internal/queryapi/server/workunits_route.go#buildWorkUnitsRoute` |
| POST | `/api/v1/work-units/{work_unit_id}/explain` | ported | `internal/queryapi/server/workunit_explain_route.go#buildWorkUnitExplainRoute` |
...
| compounding_risk | NATIVE, post_bridge (ordering phase only; no bridge call exists) | Go: `internal/jobs/metrics/daily/compounding_risk_native_executor.go` (`CompoundingRiskExecutor`) | CHAOS-4287/CHAOS-5308 (Done) |
...
| investment.materialize | NATIVE | Go: `internal/jobs/investment/nativeexecutor.go` (implements the same `workgraph.NativeExecutor` seam the bridge did) -> `materialize.go` orchestrator -> `chquery` fetch + `materializecomponent.go` assembly + `categorize` LLM plane + `chwrite` write. Python `src/dev_health_ops/work_graph/investment/materialize.py:1169-1854 materialize_investments()` is retained but no longer reached from the worker path (removal is CHAOS-4767) | river, native -- `addWorkgraphWorker`'s `KindInvestmentMaterialize` case takes `nativeInvestment` | CHAOS-4441 (cutover landed) |
